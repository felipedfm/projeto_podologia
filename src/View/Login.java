...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LabelTituloLogin.setFont(new java.awt.Font("Yu Gothic", 1, 48)); // NOI18N
        LabelTituloLogin.setForeground(new java.awt.Color(0, 153, 153));
        ...
        LabelUsuario.setFont(new java.awt.Font("Yu Gothic", 1, 18)); // NOI18N
        ...
        TextUsuario.setFont(new java.awt.Font("Yu Gothic", 0, 12)); // NOI18N
        TextUsuario.setForeground(new java.awt.Color(0, 153, 153));
        TextUsuario.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 102)));
        ...
        TextSenha.setFont(new java.awt.Font("Yu Gothic", 0, 12)); // NOI18N
        TextSenha.setForeground(new java.awt.Color(0, 153, 153));
        TextSenha.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 102)));
        ...
        ButtonEntrar.setFont(new java.awt.Font("Yu Gothic", 1, 20)); // NOI18N
        ButtonEntrar.setForeground(new java.awt.Color(0, 153, 153));
        ButtonEntrar.setText("ENTRAR");
        ButtonEntrar.setActionCommand("ButtonEntrar");
        ButtonEntrar.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 102, 102)));
        ...
        LabelLoginFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/imagens/Logo.png"))); // NOI18N
